...
- success_rate: (liczba_zaplanowanych_wykonań_w_okresie > 0 ? liczba_wykonanych / zaplanowane : 0).
- Próg sukcesu nawyku: 75% realizacji do dnia deadline’u (o ile zdefiniowany).
- Harmonogram: dni tygodnia + opcjonalna liczba powtórzeń/dzień (np. 10 stron/dzień).
- „częściowe wykonanie”: dzienna formuła 1 - wykonane/zaplanowane, przy czym wykonane <= zaplanowane. Dzień z "częściowe wykonanie" > 0 liczy się w success_rate jako 1 - "częściowe wykonanie".
- "częściowe wykonanie" - jako opcja - checkbox przy tworzeniu nawyku.
